...
const reviews: ProductReview[] = [
  {
    ...
    text: 'The finish looks clean and the light works perfectly in a small reading corner.',
    status: 'approved',
    userId: 101,
    productId: 501,
    authorName: 'Olya D.',
  ...
  },
  {
    ...
    text: 'Easy to place and nice quality. I only wish the cable were a bit longer.',
    status: 'approved',
    userId: 102,
    productId: 501,
    authorName: 'Max K.',
